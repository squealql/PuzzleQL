    ...
    return (
        <div className={cn("flex flex-col gap-6", className)} {...props}>
            <Card className="bg-white dark:bg-ui-navy-800 border-ui-navy-200 dark:border-ui-navy-700">
                <CardHeader>
                    <CardTitle className="text-2xl text-ui-navy-900 dark:text-white">Reset Your Password</CardTitle>
                    <CardDescription className="text-ui-navy-500 dark:text-ui-beige-300">Please enter your new password below.</CardDescription>
                </CardHeader>
                <CardContent>
