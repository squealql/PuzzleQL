...
import { Database, Table, Key, FileText, Upload, AlertCircle, Link, ArrowRight } from 'lucide-react';
...
const parseColumnOrConstraint = (item: string, columns: Column[], constraints: Constraint[]): void => {
  ...
  const isConstraint: boolean = constraintTypes.some(type => 
    ...
    return (
      <g key={index}>
        ...
        <text
          ...
          y={(fromY + toY) / 2 - 10}
          textAnchor="middle"
          style={{ fontSize: '10px', fill: 'hsl(var(--block-blue-600))' }}
        >
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="grid xl:grid-cols-3 gap-8">
          ...
          <div className="xl:col-span-2 space-y-4">
            ...
            {parsedSchema ? (
              <div className="rounded-lg overflow-hidden shadow-sm" style={{ background: 'hsl(var(--ui-beige-200))', border: '1px solid hsl(var(--ui-navy-200))' }}>
                {/* Schema Diagram */}
                  ...
                  {(() => {
                    ...
                    return (
                      <svg
                        ...
                        style={{ border: '1px solid hsl(var(--ui-navy-200))', borderRadius: '0.5rem', background: 'hsl(var(--ui-beige-100))' }}
                      >
                        <defs>
                          <marker
                            id="arrowhead"
                ...
                {selectedTable && (
                  <div className="border-t p-6" style={{ borderColor: 'hsl(var(--ui-navy-200))', background: 'hsl(var(--ui-beige-100))' }}>
                    {(() => {
                      ...
                      return (
                        <div>
                          <h3 className="text-lg font-semibold mb-4 flex items-center gap-2" style={{ color: 'hsl(var(--ui-navy-700))' }}>
                            ...
                            <div>
                              ...
                              <div className="space-y-2 max-h-64 overflow-y-auto">
                                {table.columns.map((column: Column, index: number) => (
                                  <div key={index} className="border rounded p-3" style={{ borderColor: 'hsl(var(--ui-navy-200))', background: 'white' }}>
                                    <div className="flex items-center justify-between mb-1">
                                      <div className="flex items-center gap-2">
                                        <span className="font-medium" style={{ color: 'hsl(var(--ui-navy-900))' }}>{column.name}</span>
                                        <span className="text-xs px-2 py-1 rounded" style={{ background: 'hsl(var(--ui-navy-200))', color: 'hsl(var(--ui-navy-900))' }}>
                                          {column.dataType}
                                        </span>
                                      </div>
                                      {column.constraints.includes('PRIMARY KEY') && (
                                    ...
                                    {relatedTables.length > 0 ? (
                                      <div className="space-y-2">
                                        {relatedTables.map((rel: Relationship, index: number) => (
                                          <div key={index} className="flex items-center gap-2 text-sm p-2 rounded" style={{ background: 'hsl(var(--block-blue-400))', color: 'white' }}>
              ...
              <div className="border-2 border-dashed rounded-lg p-12 text-center" style={{ background: 'hsl(var(--ui-beige-200))', borderColor: 'hsl(var(--ui-navy-200))' }}>
