    ...
    tables: {
            ...
            data: [
                {
                    ...
                    is_active: true,
                    last_login: "2024-07-15 14:22:33",
                },
                {
                    id: 2,
                    username: "jane_smith",
                    ...
                    is_active: true,
                    last_login: "2024-07-14 09:15:21",
                },
                { id: 3, username: "bob_wilson", email: "bob@example.com", created_at: "2024-01-17 09:15:00", is_active: false, last_login: null },
                {
                    ...
                    is_active: true,
                    last_login: "2024-07-16 11:08:45",
                },
                {
                    id: 5,
                    ...
                    is_active: true,
                    last_login: "2024-07-13 16:42:12",
                },
                {
                    id: 6,
                    ...
                    is_active: false,
                    last_login: "2024-06-20 13:55:30",
                },
                {
                    id: 7,
                    username: "frank_miller",
                    email: "frank@example.com",
                    created_at: "2024-02-05 12:15:00",
                    is_active: true,
                    last_login: "2024-07-16 18:30:15",
                },
            ],
        },
        orders: {
        ...
        suppliers: {
            ...
            data: [
                ...
                {
                    supplier_id: 503,
                    company_name: "PeripheralPro",
                    contact_person: "Anna Rodriguez",
                    email: "anna@peripheralpro.com",
                    phone: "+1-555-0103",
                    country: "Mexico",
                ...
                {
                    supplier_id: 504,
                    company_name: "KeyboardKings",
                    contact_person: "David Smith",
                    email: "david@keyboardkings.com",
                ...
                {
                    supplier_id: 505,
                    company_name: "CameraSupply Co",
                    contact_person: "Lisa Wang",
                    email: "lisa@camerasupply.com",
                ...
                {
                    supplier_id: 507,
                    company_name: "MobileCover Express",
                    contact_person: "Priya Patel",
                    email: "priya@mobilecover.in",
...
const Sidebar: React.FC<SidebarProps> = ({ tables, selectedTable, onTableSelect }) => {
    return (
        <aside className="w-72 bg-ui-beige-100 border-r border-ui-navy-200 p-6" style={{ borderColor: "var(--ui-navy-200)" }}>
            <h2 className="text-xl font-semibold text-ui-navy-900 mb-6" style={{ color: "var(--ui-navy-900)" }}>
                Database Tables
            </h2>
                ...
                {Object.entries(tables).map(([tableName, table]) => (
                    <button
                        ...
                        className={`w-full text-left p-4 rounded-lg transition-colors duration-150 border-2 ${
                            selectedTable === tableName ? "border-ui-navy-400 text-ui-navy-950" : "border-transparent text-ui-navy-700 hover:ui-beige-200"
                        }`}
                        style={{
...
const TableDisplay: React.FC<TableDisplayProps> = ({ table }) => {
        ...
        return (
            <main className="flex-1 flex items-center justify-center bg-ui-beige-100">
                <div className="text-center">
                    ...
                    <p className="text-ui-navy-500">Choose a table from the sidebar to view its raw data</p>
                </div>
            </main>
        );
    }
    ...
    return (
        <main className="flex-1 bg-ui-beige-100">
            {/* Table Header */}
            <div className="border-b p-6 bg-ui-beige-100" style={{ borderColor: "var(--ui-navy-200)" }}>
            ...
            {/* Table Container */}
            <div className="p-6 bg-ui-beige-100">
                <div className="border rounded-lg overflow-hidden shadow-sm bg-ui-beige-100" style={{ borderColor: "var(--ui-navy-200)" }}>
                            ...
                            <tbody>
                                {table.data.map((row, rowIndex) => (
                                    <tr
                                        ...
                                        style={{
                                            backgroundColor: rowIndex % 2 === 0 ? "var(--ui-beige-100)" : "var(--ui-beige-200)",
                                        }}
                                        onMouseEnter={(e) => {
                                            e.currentTarget.style.backgroundColor = "var(--ui-navy-100)";
                                        }}
                                        onMouseLeave={(e) => {
                                            e.currentTarget.style.backgroundColor = rowIndex % 2 === 0 ? "var(--ui-beige-100)" : "var(--ui-beige-200)";
                                        }}
                                    >
                                        {table.columns.map((columnName) => {
...
export default function SQLDataViewer() {
    ...
    return (
        <div className="min-h-screen bg-ui-beige-300 dark:bg-ui-navy-950">
            {/* Header */}
            <SiteHeader>
                <nav className="w-full flex justify-center border-b border-b-foreground/10 h-16 bg-white dark:bg-ui-navy-900">
                    <div className="w-full max-w-7xl flex justify-between items-center p-3 text-sm">
                        ...
                        <div className="flex items-center gap-4">
                            <button
                                className="flex items-center gap-2 px-4 py-2 text-white rounded-lg transition-colors duration-150 font-medium bg-ui-navy-700 hover:bg-ui-navy-600"
                                onClick={() => {
